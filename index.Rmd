...
Slides for ISEAK course:

Thursday:
    - [Slides](./slides_iseak/thursday_afternoon/01_introduction.html)

Friday: 
    - [Slides](./slides_iseak/friday_morning/regularization/02_regularization_afternoon.html)
    - [Slides](./slides_iseak/friday_morning/loss_decisiontrees/03_loss_trees.html)
    - [Slides](./slides_iseak/friday_morning/tree_methods/tree_methods.html)

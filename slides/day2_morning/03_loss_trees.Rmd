...
* All `plug_*` functions serve to build your machine learning workflow 

* `tidyflow`: receives the data and seed

* `plug_split`: add the training/testing

* `plug_formula`/`plug_recipe`: model definition

* `plug_model`: the model used

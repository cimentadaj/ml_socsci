...
#### 1) Split the data into test/training data
...
#### 3) Which are the most important variables?
...
#### 4) Run a lasso regression with the same specification as above
...
#### 5) Run an elastic net regression on non cognitive skills
